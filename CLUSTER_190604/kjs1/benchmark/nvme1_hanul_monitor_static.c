...
int migrator_create(int nummigrator, char* input)
{
	...
	if(strcmp(input, "0.0tb") != 0){ // when migration is needed
		...
		int tog = 0;
		//FILE* trackfp = fopen("/mnt/tracking", "a+");
				...
				if(fgets(space, sizeof(space)-1, fp) != NULL){
					...
					*/
					...
					if(toggle){	//nvme is full
						system("sh /home/dcslab/benchmark/write_1.sh 30");
						printf("%s\n", "sh /home/dcslab/benchmark/write_1.sh 30");
						reply = redisCommand(c, "SET %s %d", "MIGRATE", 1);
						freeReplyObject(reply);
						...
						if (intspace < threshold){
							...
							freeReplyObject(reply);
							//add 190518
							//system("sh /home/dcslab/benchmark/read_1.sh 30");
							//printf("%s\n", "sh /home/dcslab/benchmark/read_1.sh 30");
							//system("sh /home/dcslab/benchmark/write_1.sh 890");
							//printf("%s\n", "sh /home/dcslab/benchmark/write_1.sh 890");
							
						}
						else {
							system("sh /home/dcslab/benchmark/write_1.sh 800");
							printf("%s\n", "sh /home/dcslab/benchmark/write_1.sh 800");
